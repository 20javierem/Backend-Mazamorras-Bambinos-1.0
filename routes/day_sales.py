...
@router.post("/", response_model=DaySaleReadCreate, status_code=status.HTTP_201_CREATED)
...
@router.get("/{id}", response_model=DaySaleReadWithDetails, status_code=status.HTTP_200_OK)
...
@router.patch('/{id}', response_model=DaySaleReadWithDetails, status_code=status.HTTP_202_ACCEPTED)
...
@router.get("/date/{date}", response_model=DaySaleReadWithDetails, status_code=status.HTTP_200_OK)
